...
const portfolioData = [
  { company: "한화솔루션", entry: "31,000원", current: "36,000원", date: "26.03.20", result: "+36.3%", period: "40일" },
  { company: "삼성전자",   entry: "55,000원", current: "72,000원", date: "26.02.15", result: "+30.9%", period: "36일" },
  { company: "카카오",     entry: "42,000원", current: "53,500원", date: "26.01.28", result: "+27.4%", period: "54일" },
  { company: "네이버",     entry: "180,000원", current: "225,000원", date: "26.02.05", result: "+25.0%", period: "46일" },
  { company: "SK하이닉스", entry: "120,000원", current: "162,000원", date: "26.03.01", result: "+35.0%", period: "22일" },
];
...
const reviewCards = [
  ...
  { title: "코인에서 큰 손실 보셨던", desc: "20대 대학원생 김서연님", emoji: "👩‍🔬" },
  { title: "시드가 적어서 고민하시던", desc: "대전 사회초년생 조민수님", emoji: "👨‍🎓" },
  { title: "투자 정보 판별이 어려우셨던", desc: "40대 자영업 한소희님", emoji: "👩‍🎤" },
        ...
        >
          {doubled.map((card, i) => (
            ...
            >
              ...
              <p className="text-xs text-gray-300 my-4">제공일 {card.date}</p>

              {/* 성과 */}
              <div className="border-t border-gray-100 pt-5">
                <p className="text-[13px] text-[#FF4D00] font-semibold mb-1">전략 성과</p>
    ...
    <FadeIn className="py-24 lg:py-28 px-6 lg:px-12 bg-[#1a1a1a] text-white">
      <div className="max-w-[1000px] mx-auto text-center">
        ...
        <div className="text-center">
          ...
          <h3 className="text-2xl font-extrabold mb-9">김범준 대표이사</h3>
